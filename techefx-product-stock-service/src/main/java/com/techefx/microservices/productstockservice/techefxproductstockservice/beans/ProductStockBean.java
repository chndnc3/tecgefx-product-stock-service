...
public class ProductStockBean {
	...
	public String toString() {
		return String.format(
				"ProductStockBean [id=%s, productName=%s, productPrice=%s, productAvailability=%s, discountOffer=%s, port=%s]",
				id, productName, productPrice, productAvailability, discountOffer, port);
	}
